...
class HomePageResponse extends BaseMappable{
  bool status;
  String errNum;
  String msg;
  Data data;
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    msg = json['msg'];
    data = json['data'] != null ? new Data.fromJson(json['data']) : null;
    return HomePageResponse(status: status,msg: msg,errNum: errNum,data: data);
  }
}
...
class HomePageResponse extends BaseMappable{
  ...
  Mappable fromJson(Map<String, dynamic> json) {
    ...
    msg = json['msg'];
    data = json['data'] != null ? new Data.fromJson(json['data']) : null;
    return HomePageResponse(status: status,errNum: errNum,msg: msg,data: data);
  }
}
