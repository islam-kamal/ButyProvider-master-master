...
import 'package:BeauT_Stylist/models/current_ordera_model.dart' as current_model;
...
class _FinishedReservationViewState extends State<FinishedReservationView> {
  ...
  void initState() {
    ...
    currentOrdersBloc.add(FinishedReservatiosnEvent());
    super.initState();
  }
              ...
              return  Padding(
                ...
                child: Center(
                    child: Text(allTranslations.currentLanguage == "en"
                        ? "No Reservations"
                        : "ليس لديك طلبات مكتملة حتي الان")),
              );
            } else {
              return StreamBuilder<CurrentOrdersResponse>(
                stream: currentOrdersBloc.fnished_reservations_subject,
  ...
  Widget services(List<current_model.Services> services){
